...
const faqs = [
  { question: 'What is the cheapest London tour?', answer: `The Jack the Ripper walking tour is the lowest priced experience at £15 per person, and the Thames Sightseeing Cruise is the cheapest attraction ticket at £17. The View from The Shard starts at £24, making it another strong budget option.` },
  { question: 'Are cheap London tours worth it?', answer: 'Absolutely. Price does not determine quality. The Thames cruise has over 24,000 reviews with a 4.5 rating, and The Shard viewing experience is rated 4.5. These are genuinely world-class experiences at affordable prices.' },
...
const miniReviews: Record<string, string> = {
  ...
  'the-shard-tickets': 'At £24, this is one of the most affordable ways to see London from above. The views from floors 68 to 72 of Western Europe\'s tallest building stretch up to 40 miles on a clear day. The open-air sky deck on level 72 is genuinely thrilling. Visit at sunset for the most impressive experience, watching London transform from daylight to a glittering cityscape.',
  'hop-on-hop-off-bus': 'A full day of sightseeing from £25 is remarkable value. Tickets come as 1-day, 24, 48 or 72-hour passes and let you ride open-top double-decker buses across 48 stops on 3 routes, hopping off wherever you like. On-board audio commentary in 11 languages covers every major landmark. It is particularly useful for first-time visitors who want to get their bearings and see everything.',
  'london-dungeon-tickets': 'An action-packed 90 minutes of immersive entertainment for £24. The London Dungeon combines live actors, special effects, and dark comedy to bring London\'s gruesome history to life. From Jack the Ripper to the Great Plague, each of the 14 shows delivers genuine thrills. Best suited for older children and adults who enjoy a good scare.',
  'madame-tussauds-tickets': 'Two to three hours of entertainment for £24 per person. Madame Tussauds remains one of London\'s most visited attractions, with more than 150 incredibly lifelike wax figures. The Marvel and Star Wars zones are standout additions. Perfect for a rainy day or as a fun break between more serious sightseeing.',
  'st-pauls-cathedral-tickets': 'One of London\'s architectural masterpieces for £24. Climbing the 528 steps to the Golden Gallery rewards you with some of the finest panoramic views in the city. The Whispering Gallery acoustics are fascinating, and the crypt houses memorials to some of Britain\'s greatest heroes. Allow 2 hours to see everything.',
  'london-eye-tickets': 'A London icon that lives up to the hype. The 30-minute rotation gives you plenty of time to spot landmarks and take photos from 135 metres up. At £25, it is slightly cheaper than The Shard, but the glass capsule experience and South Bank location make it a different and equally worthwhile perspective on the city.',
};

export const metadata: Metadata = {
  title: 'Best Cheap London Tours Under £30 in 2026 | Budget-Friendly Attractions',
  description: `Discover ${budgetTours.length} brilliant London tours under £30. Thames cruises from £17, The Shard from £24, and more. Save money without missing the best experiences.`,
