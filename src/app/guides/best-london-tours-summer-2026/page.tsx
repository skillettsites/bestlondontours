...
const summerTours: SummerTour[] = [
  {
    ...
    category: 'outdoor',
    description: [
      'The Highlights of Royal London Bike Tour is one of the best ways to cover ground in the summer sunshine. Over 3 hours, a friendly guide leads you from beside Waterloo station past Buckingham Palace, The Mall, Big Ben and Westminster Abbey, sticking to bike lanes and parks. Rated 4.8, this tour consistently earns rave reviews for its relaxed pace and knowledgeable guides.',
      'Summer is the ideal season for cycling in London, with dry roads, warm weather, and long daylight hours. The route sticks to cycle paths and parks, making it suitable for riders of all abilities. A comfortable cruiser bike and your guide are included, and open-toed shoes are not permitted. At £42 per person, this is good value for a half-day experience.',
    ],
  },
  {
    ...
    category: 'outdoor',
    description: [
      'For a truly unique summer experience, the Richmond Thames kayak adventure lets you paddle the calm backwaters of the upper Thames, exploring hidden islands, quiet channels and paddle-friendly riverside pubs. This is the Thames from a perspective very few visitors ever see. Your booking includes the kayak, paddle, buoyancy aid, a dry bag and a safety briefing with route guidance before you set off.',
      'This is a self-guided paddle rather than a led tour, so you need to be able to paddle independently. GetYourGuide lists it as not suitable for children under 10 or for non-swimmers, and under 18s must be accompanied on the water. Summer is the practical season for it, as water temperatures and daylight hours make it comfortable. Prices start from £43 per person.',
    ],
  },
  {
    ...
    category: 'outdoor',
    description: [
      'London\'s royal parks are at their absolute best in summer, with roses in full bloom and locals picnicking on every stretch of green. The Royal Parks and Buckingham Palace tour starts outside Green Park station and walks you through the ceremonial heart of the city and on into Hyde Park, with commentary on royal history, the Changing of the Guard, and how these green spaces went from royal hunting grounds to public parks.',
      'This gentle 2-hour walk runs at a relaxed pace, making it suitable for all fitness levels and ages. You see the exterior of Buckingham Palace and the royal parks around it before heading into Hyde Park; entry into the palace is not included. At £28 per person, it is an affordable morning activity that pairs well with a State Rooms visit afterwards.',
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      'Prices start from £95 per person and include a welcome glass of sparkling wine, a three-course menu, tea and coffee, and live music with optional dancing. Gluten-free meals need 24 hours\' notice and the vegetarian menu must be pre-ordered, and the cruise is not suitable for children under 13. This is one of the most popular summer evening experiences in London, so book at least 2 weeks in advance for weekend dates. Smart casual dress is recommended.',
    ],
  },
  {
    ...
    category: 'walking',
    description: [
      'Borough Market is London\'s oldest and most famous food market, and a guided food tour is the best way to experience it. Over 3 hours, an expert guide leads you through the bustling stalls, stopping for six curated British tastings: a bacon and egg bap, a traditional sausage roll, award-winning fish and chips, artisan British cheeses with chutney, a classic English dessert and a local ale, cider or mead, plus a secret dish revealed on the day. Rated 4.8, this is the top-rated food experience in the city.',
      'Summer brings peak produce season to the market, with English strawberries, asparagus, and fresh herbs adding colour and flavour to every stall. The tour runs in the morning to catch the market at its liveliest, and you will leave too full for lunch. At £92 per person, it is a premium experience, but the quality and quantity of food included makes it good value. Note it is not suitable for wheelchair users or people with mobility impairments.',
    ],
  },
  {
    ...
    category: 'food',
    description: [
      'Afternoon tea is one of the most quintessentially British experiences you can have, and London does it better than anywhere else. The Royal Afternoon Tea in the Palace Lounge at The Rubens at the Palace offers savoury finger sandwiches, freshly baked scones with clotted cream and homemade preserves, and a selection of delicate pastries, all served with tea or coffee.',
      'The sitting runs about 1.5 hours in a 5-star hotel lounge, and there is an option that adds a glass of Champagne. Prices start from £83 per person. This is a lovely way to spend a relaxed afternoon between morning sightseeing and an evening activity. Dress is smart casual, and booking a few days ahead is recommended.',
    ],
  },
  {
  ...
  },
  {
    ...
    category: 'evening',
    description: [
      'The London Ghost Tour delivers 2 hours of haunted history through the oldest parts of the city. Rated 4.9 from over 800 reviews, this walk takes you past plague pits, execution sites, and haunted pubs while a theatrical guide shares stories spanning 2,000 years of London\'s darkest moments.',
      'Summer evenings add a unique twist: you start the tour in daylight and gradually watch the city grow darker as the stories grow more chilling. The tour finishes around 9:30pm, leaving time for a late dinner. At £25 per person, it is an affordable evening activity and a memorable way to spend a summer night.',
    ],
  },
  {
    ...
    description: [
      ...
      'Audio commentary is available in multiple languages, and most tickets include a bonus Thames river cruise. Children love sitting on the top deck and spotting landmarks, making this an easy, stress-free way to keep the whole family entertained. At £25 per person for a full day, the value is hard to beat. Start early in the morning to avoid the midday crowds on the most popular routes.',
    ],
  },
  {
    ...
    price: 'From £71',
    duration: '11 hours to a full day',
    ...
    description: [
      ...
      'Long summer days mean you get the most daylight for sightseeing, and the English countryside looks stunning in green. The tour departs from central London early in the morning and returns by early evening. At £71 per person it covers a huge amount of ground and includes comfortable coach travel with an experienced guide, though the lowest fare excludes all entrance fees. Book at least a week in advance during summer, as this tour fills up quickly.',
    ],
  },
];
