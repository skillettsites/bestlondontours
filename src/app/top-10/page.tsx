...
const topReviews: Record<string, string> = {
  ...
  'st-pauls-cathedral-tickets': 'Sir Christopher Wren\'s masterpiece earns the highest individual rating on our list at 4.7 stars. Climbing the 528 steps to the Golden Gallery is demanding but the reward is one of the most spectacular panoramic views in London. The Whispering Gallery acoustics fascinate children and adults alike. At £24, it represents outstanding value for an experience of this calibre.',
  ...
  'the-shard-tickets': 'Western Europe\'s tallest building offers views stretching up to 40 miles on a clear day. At just £24, The Shard is among the most affordable viewpoints in London and one of the most dramatic. The open-air sky deck on level 72 is genuinely exhilarating. Visit at sunset for the most spectacular experience, watching the city transform as darkness falls. Over 8,500 reviews at 4.6 stars.',
...
const faqs = [
  ...
  { question: 'What is the best value London tour?', answer: `The Thames Sightseeing Cruise at £17 per person offers incredible value. The View from The Shard at £24 is another standout. Both have thousands of positive reviews and deliver genuinely memorable experiences at very reasonable prices.` },
];
