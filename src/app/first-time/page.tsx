...
const faqs = [
  ...
  { question: 'Can you do these 5 tours in one day?', answer: 'Yes, this itinerary is designed to flow from morning to evening. Start with the bus tour around 9am, visit the Tower from 11am, cruise the Thames at 1:30pm, reach Buckingham Palace by 3pm, and finish at the London Eye around 5:30pm. Total cost is approximately £137 per person if you book all five.' },
  { question: 'How much does a day of London tours cost?', answer: `Booking all five tours on this list costs approximately £${essentialTours.reduce((s, t) => s + t.price, 0)} per person. You could also pick your top 3 to keep costs down. The Thames cruise (£17) and hop-on hop-off bus (£25) offer the best value individually.` },
