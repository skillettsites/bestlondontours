...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How much do day trips from London cost?', answer: 'Organised coach tours range from £55 to £95 per person depending on the destination. Independent train fares can be cheaper but you lose the guided commentary and logistical convenience.' },
  ...
  },
  {
    ...
    relatedTourSlugs: ['thames-sightseeing-cruise', 'london-bike-tour', 'borough-market-food-tour', 'jack-the-ripper-tour', 'london-ghost-tour', 'thames-dinner-cruise', 'hop-on-hop-off-bus', 'london-royal-parks-tour', 'london-thames-kayak-tour', 'windsor-stonehenge-bath-tour', 'london-gin-distillery-tour'],
    faqs: [
