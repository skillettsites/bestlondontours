  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'For families, City Sightseeing is the safe pick: the classic red open-top bus is an attraction in itself for children, the central loop is short enough to hold their attention, and dedicated kids\' commentary is available on the audio system. Big Bus suits families who plan to hop off at lots of stops, as its higher frequency means less waiting around with restless children. Golden Tours works well for budget-conscious families, especially with its combo tickets that bundle the bus with child-friendly attractions like Madame Tussauds and SEA LIFE. All three allow pushchairs to be folded and stored on the lower deck. Sitting on the top deck at the front is the most exciting spot for children.',
      },
      {
